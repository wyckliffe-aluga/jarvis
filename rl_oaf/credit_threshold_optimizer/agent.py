...
class Agent: 
    ...
    # perfom value function update based on (previous, state-action-state-reward) tuples 
    ...
    # run one episode 
    def play_one(self, sample_action, train = True, visualize_learning = 0, save = False, path = 'bookkeeping/baseline_final/episode_0/'):
